    ...
    <main>
      ...
      {ingredients.length > 0 && (
        <section className="ingredientsSection">
          <h2 className="ingredientsHeader">Ingredients on hand:</h2>
          ...
          {ingredients.length >= 4 && (
            <div className="getRecipeContainer">
              ...
              <button className="getRecipeButton" onClick={submitIngredients}>
                Get a recipe
              </button>
            </div>
          )}
      ...
      {recipeShown && (
        <section className="recipeSection">
          <h2 className="recipeHeader">Chef Claude Recommends:</h2>
